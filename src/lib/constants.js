...
export const PSYCHOLOGY_LESSONS = [
  { number: 1, title: "ANYTHING CAN HAPPEN", description: "Gak ada strategi yang 100% win rate. SL hit = plan executed = that is a WIN. Setiap entry cuma satu bagian dari probabilitas. Jangan baper pas kena SL sekali lalu gonta-ganti setup. Market is bigger than any of us." },
  { number: 2, title: "THINK IN PROBABILITIES, NOT CERTAINTIES", description: "Trader pro gak berusaha nebak market secara mutlak. Kita cuma cari edge (probabilitas). Eksekusi yang konsisten, biar hukum statistik yang bekerja. You are a researcher who occasionally hits buttons." },
  { number: 3, title: "ACCEPT THE RISK BEFORE ENTERING", description: "Sebelum klik Buy, mental & modalmu harus ikhlas duit risk itu ilang. Anggap risk-nya udah hangus (already gone). Kalau gak ikhlas, pas floating minus dikit lu bakal panik, geser-geser SL, atau malah revenge trading." },
  { number: 4, title: "DETACH YOUR SELF-WORTH FROM INDIVIDUAL TRADES", description: "Kena cut loss bukan berarti lu fail atau bego. Cut loss adalah self love untuk jagain modal biar bisa trading another day. Jangan biarkan 1-2 loss nurunin mental state lu sampai fomo/takut entry setup berikutnya." },
  { number: 5, title: "CONSISTENCY COMES FROM MINDSET, NOT STRATEGY", description: "Banyak trader rungkad bukan karena strateginya jelek, tapi karena mentalnya mencla-mencle. Timothy Ronald did 10 years reps. Disiplin eksekusi 1 sistem yang konsisten itu kuncinya, bukan gonta-ganti cari holy grail." },
  { number: 6, title: "THE MARKET OWES YOU NOTHING", description: "Market itu cuek dan non-emosional. Jangan salahin market red macro, news, atau bandar kalau lu loss. Ambil tanggung jawab penuh atas eksekusi lu sendiri. Stop pointing fingers, change the trajectory of your life." },
  { number: 7, title: "ELIMINATE THE NEED TO BE RIGHT", description: "Obsesi pengen selalu bener bikin lu nahan loss (averaging down pas tesis salah) atau fomo entry. Kita di sini buat cari duit long term, bukan buat pamer ego. Terima loss sebagai biaya riset/tuition fee." },
  { number: 8, title: "EVERY SINGLE TRADE IS UNIQUE", description: "Walau chart pattern kelihatan persis sama, order flow dan partisipan di dalamnya beda. Jangan berasumsi setup kali ini bakal 100% jalan kayak trade kemarin. Tetap waspada, amati orderbook & broker summary." },
  { number: 9, title: "FOLLOW YOUR PROCESS WITHOUT HESITATION", description: "Begitu setup valid muncul sesuai checklist (focus score 7+, no UGM block, bandar akumulasi), langsung klik tanpa ragu/takut. Ragu-ragu pas setup valid cuma bikin lu ngerusak probability advantage strategi lu." },
  { number: 10, title: "DEVELOP THE FIVE FUNDAMENTAL TRUTHS", description: "Tanamkan di otak: anything can happen, lu gak perlu tau masa depan buat bikin duit, sebaran win-loss itu random, edge cuma petunjuk probabilitas lebih tinggi, dan setiap momen di market itu unik." }
];
